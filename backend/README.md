...
## Project Structure
    ...
    ├── delly_foods_deliver_43148  # Django project configurations
...
1. Clone this repo and `cd delly_foods_deliver_43148`
...
2. Clone this repo and `cd delly_foods_deliver_43148`
