"""
Django settings for delly_foods_deliver_43148 project.
...
ROOT_URLCONF = 'delly_foods_deliver_43148.urls'
...
WSGI_APPLICATION = 'delly_foods_deliver_43148.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delly_foods_deliver_43148 API",
    "DESCRIPTION": "API documentation for delly_foods_deliver_43148 App",
    "VERSION": "v1",
}
